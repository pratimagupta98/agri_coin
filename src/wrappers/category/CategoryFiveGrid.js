            ...
            <Col md="12" >
             <ul className="st-2">
                   <li className="st-1">
                    ...
                    <li className="st-1">
                     <Link to={process.env.PUBLIC_URL + "/electricity"}>{string["electricity"]}
                       <i className="pe-7s-light circle-1" />
                       <p>Electricity</p>
                     </Link>
                    </li>
                    <li className="st-1">
                     <Link to={process.env.PUBLIC_URL + "/internetbill"}>{string["internetbill"]}
              ...
              <Form>
                <div className="int-box">
                  <FormControlLabel control={<Checkbox defaultChecked />} label="Prepaid" />
                </div>
                <div className="int-box">
              ...
              <Row>
                 ...
                 <Col md="3">
                    <button type="button" class="btn-s mb-st">Continue</button>
                 </Col>
              </Row>
              </Form>
              </div>
